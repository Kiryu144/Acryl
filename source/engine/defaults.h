...
namespace Defaults {
    ...
    static glm::vec2 _plane_2D_x2[] = {glm::vec2(-1, -1), glm::vec2(1, -1), glm::vec2(-1, 1), glm::vec2(-1, 1), glm::vec2(1, 1), glm::vec2(1, -1)};
    ...
    static std::unique_ptr<VertexBufferObject> Plane_2D_X2;
    ...
    static std::string _framebuffer_vert =
        #include "opengl/shader/glsl/framebuffer.vert"
    ;

    static std::string _framebuffer_frag =
        #include "opengl/shader/glsl/framebuffer.frag"
    ;
    ...
    static std::unique_ptr<Shader> Framebuffer;
    ...
    static void init() {
        ...
        Plane_2D_X2 = std::unique_ptr<VertexBufferObject>(new VertexBufferObject(_plane_2D_x2, 12*sizeof(float), 2));
        ...
        Framebuffer =  std::unique_ptr<Shader>(new Shader(_framebuffer_vert, _framebuffer_frag, true));
